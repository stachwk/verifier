...
# Sciezki docelowe sa czytane z config.ini przekazanego jako parametr.
#
# Uzycie:
#   ./restore_verifier_state_from_config.sh /sciezka/do/config.ini /sciezka/do/katalogu_backupu
